...
function App() {
  ...
  const [visits, setVisits] = useState(() => {
    try { return JSON.parse(localStorage.getItem('careops-visits')) || initialVisits } catch { return initialVisits }
  })
  ...
  useEffect(() => { localStorage.setItem('careops-visits', JSON.stringify(visits)) }, [visits])
